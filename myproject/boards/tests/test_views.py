...
class NewTopicsTest(TestCase):
    ...
    def test_new_topic_valid_post_data(self):
        ...
        data = {
            'subject': 'Test title',
            'message': 'This is a sample messsage for testing purposes'
        }
    ...
    def test_new_topic_invalid_post_data_empty_fields(self):
        '''
        Invalid POST data should not be able to redirect
        The expected behavior once more is to show the form again with validation errors
        '''
        url = reverse('new_topic', kwargs={ 'pk': 1 })
        data = {
            'subject': '',
